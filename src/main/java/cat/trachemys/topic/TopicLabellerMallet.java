...
/**
 * Infers Mallet topics for a set of documents given a model
 * 
 * @author cristinae
 * @since 31.05.2017
 */
...
public class TopicLabellerMallet extends Commons{
	...
	public TopicLabellerMallet(String input, String extension, String language, String modelFile, String output) {
		    ...
		    try {
		        ...
		        /*for (Instance instance : testInstances){
			        double[] testProbabilities = inferencer
			                  .getSampledDistribution(instance, numIters, thinning, burnIn);
			        for (int i=0;i<20;i++){
		...
		public static void main(String[] args) {
			...
			TopicLabellerMallet topicL = new TopicLabellerMallet(input, extension, language, model, output);
